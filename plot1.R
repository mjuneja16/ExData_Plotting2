...
##read the first source file in the data frame NEI
NEI <- readRDS("summarySCC_PM25.rds")
##read the other source file in the data frame SCC
...
par(mar=c(5,5,4,2))
##plot the 'Total PM2.5 Emissions in the United States' across the years 1999-2008 (no plot appears on the screen)
